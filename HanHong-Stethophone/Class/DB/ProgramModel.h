...
@property (retain, nonatomic) NSString              *program_title;//计划标题
...
@property (assign, nonatomic) NSInteger             tag;// 1 今天。2 明天
@property (retain, nonatomic) NSString              *system_calender_reminder;//存储接送记录提醒的内容数组
