...
- (void)actionButtonClick:(UIButton *)button {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(actionClickButtonLungCallBack:tag:position:)]) {
        ...
        [self.delegate actionClickButtonLungCallBack:title tag:index position:Lung_front_bodyType];
...
- (void)initView {
    ...
    self.arrayLabelNum = @[self.labelNum1, self.labelNum2, self.labelNum3, self.labelNum4, self.labelNum5, self.labelNum6, self.labelNum7, self.labelNum8];
}
