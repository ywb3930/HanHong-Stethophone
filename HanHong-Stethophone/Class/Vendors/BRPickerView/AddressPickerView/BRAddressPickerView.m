...
- (void)parseDataSource {
    ...
    for (NSDictionary *proviceDic in self.dataSource) {
        ...
        if([proviceModel.name isEqualToString:@"其他"])continue;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view {
    ...
    // 设置分割线的颜色
    ((UIView *)[pickerView.subviews objectAtIndex:1]).backgroundColor = [UIColor colorWithRed:195/255.0 green:195/255.0 blue:195/255.0 alpha:0.3];
    //((UIView *)[pickerView.subviews objectAtIndex:0]).backgroundColor = [UIColor colorWithRed:195/255.0 green:195/255.0 blue:195/255.0 alpha:1.0];
