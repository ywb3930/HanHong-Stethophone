...
- (void)configDataSource:(id)dataSource defaultSelValue:(id)defaultSelValue {
    ...
    if (isDataSourceValid) {
        ...
        for (id obj in dataArr) {
            ...
            if ([objString isEqualToString:@"NSTaggedPointerString"] && [NSStringFromClass(itemClass) isEqualToString:@"__NSCFString"]) {
                continue;
            }
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view {
    ...
    //设置分割线的颜色
    UIView *view1 = ((UIView *)[pickerView.subviews objectAtIndex:1]);
    UIView *view2 = ((UIView *)[pickerView.subviews objectAtIndex:2]);
    view1.backgroundColor = HEXCOLOR(0xE6E6E6, 1);
    view2.backgroundColor = HEXCOLOR(0xE6E6E6, 1);
    view1.frame = CGRectMake(17, view1.frame.origin.y, screenW - 34, view1.frame.size.height);
    view2.frame = CGRectMake(17, view2.frame.origin.y, screenW - 34, view2.frame.size.height);
