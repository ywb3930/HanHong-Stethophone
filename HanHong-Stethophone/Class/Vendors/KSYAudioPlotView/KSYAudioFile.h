 ...
 */
typedef void (^KSYAudioWaveformDataCompletionBlock)(float **waveformData, int length);

//------------------------------------------------------------------------------
#pragma mark - KSYAudioFileDelegate
//------------------------------------------------------------------------------
/**
 The KSYAudioFileDelegate provides event callbacks for the KSYAudioFile object. These type of events are triggered by reads and seeks on the file and gives feedback such as the audio data read as a float array for visualizations and the new seek position for UI updating.
 */
@protocol KSYAudioFileDelegate <NSObject>

@optional
/**
 Triggered from the KSYAudioFile function `readFrames:audioBufferList:bufferSize:eof:` to notify the delegate of the read audio data as a float array instead of a buffer list. Common use case of this would be to visualize the float data using an audio plot or audio data dependent OpenGL sketch.
 @param audioFile        The instance of the KSYAudioFile that triggered the event.
 ...
 */
- (void)audioFile:(KSYAudioFile *)audioFile readAudio:(float **)buffer withBufferSize:(UInt32)bufferSize withNumberOfChannels:(UInt32)numberOfChannels;

//------------------------------------------------------------------------------

/**
 Occurs when the audio file's internal seek position has been updated by the KSYAudioFile functions `readFrames:audioBufferList:bufferSize:eof:` or `audioFile:updatedPosition:`. As of 0.8.0 this is the preferred method of listening for position updates on the audio file since a user may want the pull the currentTime, formattedCurrentTime, or the frame index from the KSYAudioFile instance provided.
 @param audioFile The instance of the KSYAudio in which the change occured.
 */
- (void)audioFileUpdatedPosition:(KSYAudioFile *)audioFile;

//------------------------------------------------------------------------------

/**
 Occurs when the audio file's internal seek position has been updated by the KSYAudioFile functions `readFrames:audioBufferList:bufferSize:eof:` or `audioFile:updatedPosition:`.
 @param audioFile     The instance of the KSYAudio in which the change occured
 ...
 */
- (void)audioFile:(KSYAudioFile *)audioFile updatedPosition:(SInt64)framePosition  __attribute__((deprecated));
...
//------------------------------------------------------------------------------
/**
 The KSYAudioFile provides a lightweight and intuitive way to asynchronously interact with audio files. These interactions included reading audio data, seeking within an audio file, getting information about the file, and pulling the waveform data for visualizing the contents of the audio file. The KSYAudioFileDelegate provides event callbacks for when reads, seeks, and various updates happen within the audio file to allow the caller to interact with the action in meaningful ways. Common use cases here could be to read the audio file's data as AudioBufferList structures for output (see KSYOutput) and visualizing the audio file's data as a float array using an audio plot (see KSYAudioPlot).
 */
@interface KSYAudioFile : NSObject <NSCopying>
...
/**
 A KSYAudioFileDelegate for the audio file that is used to return events such as new seek positions within the file and the read audio data as a float array.
 */
@property (nonatomic, weak) id<KSYAudioFileDelegate> delegate;
...
/**
 Creates a new instance of the KSYAudioFile using a file path URL.
 @param url The file path reference of the audio file as an NSURL.
 @return The newly created KSYAudioFile instance. nil if the file path does not exist.
 */
- (instancetype)initWithURL:(NSURL *)url;

/**
 Creates a new instance of the KSYAudioFile using a file path URL with a delegate conforming to the KSYAudioFileDelegate protocol.
 @param delegate The audio file delegate that receives events specified by the KSYAudioFileDelegate protocol
 @param url The file path reference of the audio file as an NSURL.
 @return The newly created KSYAudioFile instance.
 */
- (instancetype)initWithURL:(NSURL *)url delegate:(id<KSYAudioFileDelegate>)delegate;

//------------------------------------------------------------------------------

/**
 Creates a new instance of the KSYAudioFile using a file path URL with a delegate conforming to the KSYAudioFileDelegate protocol and a client format.
 @param url      The file path reference of the audio file as an NSURL.
 @param delegate The audio file delegate that receives events specified by the KSYAudioFileDelegate protocol
 ...
 @return The newly created KSYAudioFile instance.
 */
- (instancetype)initWithURL:(NSURL *)url delegate:(id<KSYAudioFileDelegate>)delegate clientFormat:(AudioStreamBasicDescription)clientFormat;
...
/**
 Class method that creates a new instance of the KSYAudioFile using a file path URL.
 @param url The file path reference of the audio file as an NSURL.
 @return The newly created KSYAudioFile instance.
 */
...
/**
 Class method that creates a new instance of the KSYAudioFile using a file path URL with a delegate conforming to the KSYAudioFileDelegate protocol.
 @param url The file path reference of the audio file as an NSURL.
 @param delegate The audio file delegate that receives events specified by the KSYAudioFileDelegate protocol
 @return The newly created KSYAudioFile instance.
 */
+ (instancetype)audioFileWithURL:(NSURL *)url delegate:(id<KSYAudioFileDelegate>)delegate;

//------------------------------------------------------------------------------

/**
 Class method that creates a new instance of the KSYAudioFile using a file path URL with a delegate conforming to the KSYAudioFileDelegate protocol and a client format.
 @param url The file path reference of the audio file as an NSURL.
 @param delegate The audio file delegate that receives events specified by the KSYAudioFileDelegate protocol
 ...
 @return The newly created KSYAudioFile instance.
 */
+ (instancetype)audioFileWithURL:(NSURL *)url delegate:(id<KSYAudioFileDelegate>)delegate clientFormat:(AudioStreamBasicDescription)clientFormat;
...
/**
 Reads a specified number of frames from the audio file. In addition, this will notify the KSYAudioFileDelegate (if specified) of the read data as a float array with the audioFile:readAudio:withBufferSize:withNumberOfChannels: event and the new seek position within the file with the audioFile:updatedPosition: event.
...
/**
 Seeks through an audio file to a specified frame. This will notify the KSYAudioFileDelegate (if specified) with the audioFile:updatedPosition: function.
...
/**
 ...
 @return An NSURL representing the path of the KSYAudioFile instance.
 */
...
/**
 ...
 @return A KSYAudioFloatData instance containing the audio data for all channels of the audio.
 */
...
/**
 ...
 @param completion A KSYAudioWaveformDataCompletionBlock that executes when the waveform data has been extracted. Provides a `KSYAudioFloatData` instance containing the waveform data for all audio channels.
 */
- (void)getWaveformDataWithCompletionBlock:(KSYAudioWaveformDataCompletionBlock)completion;
...
/**
 ...
 @param completion A KSYAudioWaveformDataCompletionBlock that executes when the waveform data has been extracted. Provides a `KSYAudioFloatData` instance containing the waveform data for all audio channels.
 */
- (void)getWaveformDataWithNumberOfPoints:(UInt32)numberOfPoints completion:(KSYAudioWaveformDataCompletionBlock)completion;
...
@interface KSYAudioFloatData : NSObject
//------------------------------------------------------------------------------
