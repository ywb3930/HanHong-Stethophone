...
//    k_settingFrame(_toolBar);
    ...
    _collectionView.frame = CGRectMake(0, kNavBarAndStatusBarHeight, screenW, screenH - kNavBarAndStatusBarHeight);//self.bounds;
//    UIEdgeInsets inset = (UIEdgeInsets){Ratio10, 0.f, _toolBarSafeAreaView.frame.size.height, 0.f};
