...
@interface CreateConsultationHeaderView()<UITextFieldDelegate>
...
- (LabelTextFieldItemView *)itemTitleView{
    if (!_itemTitleView) {
        ...
        _itemTitleView.textFieldInfo.delegate = self;
        _itemTitleView.textFieldInfo.returnKeyType = UIReturnKeyDone;
    }
...
- (LabelTextFieldItemView *)itemDurationView{
    if (!_itemDurationView) {
        ...
        _itemDurationView.textFieldInfo.delegate = self;
        _itemDurationView.textFieldInfo.tag = 5;
    }
