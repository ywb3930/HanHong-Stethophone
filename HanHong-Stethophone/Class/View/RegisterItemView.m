...
- (void)initView{
    ...
    self.textFieldInfo.sd_layout.leftSpaceToView(self.imageViewStar, Ratio11).rightSpaceToView(self, 0).centerYEqualToView(self.labelTitle).bottomSpaceToView(self, 0);
